        ...
        <Col md={7} lg={6}>
          <Card className="shadow-lg border-0">
            ...
            <Card.Body className="p-4">
              {googleError && (
                <Alert variant="danger" dismissible onClose={() => setGoogleError('')}>
              ...
              <Button
                variant="light"
                size="lg"
                className="w-100 fw-semibold border mb-3"
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <span className="px-3 text-muted small fw-semibold">OR REGISTER WITH</span>
                <hr className="flex-grow-1" />
              </div>
